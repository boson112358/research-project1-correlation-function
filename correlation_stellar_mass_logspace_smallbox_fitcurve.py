...
plt.plot(X,Yf3,label='fit curve log($\zeta$) = %5.3f*log(r) + %5.3f'% tuple(popt3))
...
plt.legend()
plt.savefig('correlation_stellar_Mass3_N_2000_1000_periodic_smallbox_fitcurve.png')
